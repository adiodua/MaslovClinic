...
// the full explanation. English copy: same shape, same cover slugs (the
...
window.PATIENTS = {
  darya: {
    ...
    labels: ['Portrait, before','Portrait','Portrait','Before','Before','Before','Before','After','After, angle 2','After, angle 3','After, angle 4']
  },
  uriy: {
  ...
  irina: {
    ...
    labels: ['Portrait','Before','After','After, angle 2','After, angle 3','After, angle 4','After, angle 5']
  },
  oksana: {
